    ...
    private function data()
    {
        ...
        return [
            [
                ...
                'service_type_slug' => 'air_time',
                'logo_svg' => 'data:image/svg+xml;base64,' . base64_encode(file_get_contents($image_svg . 'air_time.svg')),
                'logo_png' => 'data:image/png;base64,' . base64_encode(file_get_contents($image_png . 'air_time.png')),
